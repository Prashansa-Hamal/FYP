...
// Email template wrapper (keep your existing template)
const emailTemplate = (content: string, title: string) => `
<!DOCTYPE html>
<html>
<head>
...
export async function sendVerificationEmail(
  ...
  await sendEmail(
    email,
    "Verify Your Email Address - DineEase",
    emailTemplate(content, "Email Verification"),
  );
}
...
export async function sendPasswordResetEmail(
  ...
  await sendEmail(
    email,
    "Reset Your Password - DineEase",
    emailTemplate(content, "Password Reset"),
  );
}
...
export async function sendOrderConfirmationEmail(
  ...
  const content = `
    ...
    <div style="text-align: center; margin-top: 20px;">
      <a href="${process.env.NEXT_PUBLIC_APP_URL}/orders" class="button">Track Your Order</a>
    </div>
  ...
  await sendEmail(
    email,
    `Order Confirmed #${orderNumber} - DineEase`,
    emailTemplate(content, "Order Confirmation"),
  );
}
...
export async function sendOrderReadyEmail(
  ...
  await sendEmail(
    email,
    `Order Ready #${orderNumber} - DineEase`,
    emailTemplate(content, "Order Ready"),
  );
}
...
export async function sendOrderCompletedEmail(
  ...
  const content = `
    ...
    <div style="text-align: center;">
      <a href="${process.env.NEXT_PUBLIC_APP_URL}/orders" class="button">View Order History</a>
      <a href="${process.env.NEXT_PUBLIC_APP_URL}/loyalty" class="button" style="margin-left: 10px;">View Points</a>
    </div>
  ...
  await sendEmail(
    email,
    `Order Completed #${orderNumber} - DineEase`,
    emailTemplate(content, "Order Completed"),
  );
}
...
export async function sendOrderCancelledEmail(
  ...
  const content = `
    ...
    <div style="text-align: center;">
      <a href="${process.env.NEXT_PUBLIC_APP_URL}/orders" class="button">View Orders</a>
      <a href="${process.env.NEXT_PUBLIC_APP_URL}" class="button" style="margin-left: 10px;">Order Again</a>
    </div>
  ...
  await sendEmail(
    email,
    `Order Cancelled #${orderNumber} - DineEase`,
    emailTemplate(content, "Order Cancelled"),
  );
}
...
export async function sendReservationConfirmationEmail(
  ...
  const content = `
    ...
    <div style="text-align: center;">
      <a href="${process.env.NEXT_PUBLIC_APP_URL}/reservations" class="button">Manage Reservation</a>
      <a href="${process.env.NEXT_PUBLIC_APP_URL}" class="button" style="margin-left: 10px;">View Menu</a>
    </div>
  ...
  await sendEmail(
    email,
    "Reservation Confirmed - DineEase",
    emailTemplate(content, "Reservation Confirmed"),
  );
}
...
export async function sendReservationCancelledEmail(
  ...
  const content = `
    ...
    <div style="text-align: center;">
      <a href="${process.env.NEXT_PUBLIC_APP_URL}/reservations" class="button">Make New Reservation</a>
      <a href="${process.env.NEXT_PUBLIC_APP_URL}" class="button" style="margin-left: 10px;">Explore Menu</a>
    </div>
  ...
  await sendEmail(
    ...
    isAdminCancellation
      ? "Your Reservation Has Been Cancelled - DineEase"
      : "Reservation Cancelled - DineEase",
    emailTemplate(content, "Reservation Cancelled"),
  );
}
...
export async function sendPaymentConfirmationEmail(
  ...
  const content = `
    ...
    <div style="text-align: center;">
      <a href="${process.env.NEXT_PUBLIC_APP_URL}/orders" class="button">View Order</a>
    </div>
  ...
  await sendEmail(
    email,
    `Payment Confirmed #${orderNumber} - DineEase`,
    emailTemplate(content, "Payment Confirmed"),
  );
}
...
export async function sendLoyaltyPointsEmail(
  ...
  const content = `
    ...
    <div style="text-align: center;">
      <a href="${process.env.NEXT_PUBLIC_APP_URL}/loyalty" class="button">View Rewards</a>
    </div>
  ...
  await sendEmail(
    email,
    `You Earned ${pointsEarned} Loyalty Points! - DineEase`,
    emailTemplate(content, "Loyalty Points Earned"),
  );
}
...
export async function sendWelcomeEmail(email: string, name: string) {
  ...
  await sendEmail(
    email,
    "Welcome to DineEase! 🎉",
    emailTemplate(content, "Welcome to DineEase"),
  );
}
...
export async function sendBirthdayGreetingEmail(email: string, name: string) {
  ...
  await sendEmail(
    email,
    "Happy Birthday from DineEase! 🎂",
    emailTemplate(content, "Happy Birthday!"),
  );
}
...
export async function sendFeedbackRequestEmail(
  ...
  await sendEmail(
    email,
    `How was your DineEase experience? - Order #${orderNumber}`,
    emailTemplate(content, "Share Your Feedback"),
  );
}
...
export async function sendPasswordChangedEmail(email: string, name: string) {
  ...
  await sendEmail(
    email,
    "Your Password Has Been Changed - DineEase",
    emailTemplate(content, "Password Changed"),
  );
}
...
export async function sendLowStockAlertEmail(
  ...
  await sendEmail(
    adminEmail,
    "Low Stock Alert - DineEase Inventory",
    emailTemplate(content, "Low Stock Alert"),
  );
}
