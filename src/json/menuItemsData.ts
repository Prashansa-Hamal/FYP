[
  ...
  },
  {
    ...
    calories: 220,
    ingredients: ["vegetables", "rice paper", "soy sauce", "sweet chili sauce"],
  ...
  {
    name: "Sushi Platter",
    description: "Assorted nigiri and rolls with wasabi, ginger, and soy sauce",
    price: 28.0,
    category: "MAIN_COURSE",
    preparationStation: "SUSHI_BAR",
    isAvailable: true,
    isVegetarian: false,
    isSpicy: false,
    isAlcoholic: false,
  ...
  },
  {
    ...
    calories: 220,
    ingredients: ["tortilla chips", "tomatoes", "onions", "cilantro", "lime"],
