...
import z from "zod";
import { logIn } from "@/app/(AUTH)/_actions/sign-in";
import { Input } from "../ui/input";
import { oAuthSignin } from "@/app/(AUTH)/_actions/oAuth-signin";
...
export const LoginDialog = ({ open, onOpen, onSuccess }: LoginDialogProps) => {
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-600">
            Please login to complete your order. Your cart items will be saved.
          </DialogDescription>
        </DialogHeader>
